...
describe("Video Link Checker", () => {
  test("Returns video links, if REPORT_ARTEFACT_URL exists", async () => {
    ...
    expect(s).toContain(
      `<http://sometesturl.com/Users/you54f/dev/saftest/githubrepos/source_repos/cypressio-docker-typescript/e2e/cypress/videos/test/cucumber-examples/BailOnStepFailure.feature.mp4|Video:- BailOnStepFailure.feature.mp4>`
    );
  });
...
describe("Get Files Checker", () => {
  test("Returns only specified filetypes if they exist in a dir", async () => {
    ...
    expect(s).toEqual([
      "/Users/you54f/dev/saftest/githubrepos/source_repos/cypressio-docker-typescript/e2e/mochareports/report-20190403-233435.html"
    ]);
  });
...
describe("Test Report Parser", () => {
  test("Reads a report a returns the results", async () => {
    ...
    const reportResult = {
      reportFile: [
        "/Users/you54f/dev/saftest/githubrepos/source_repos/cypressio-docker-typescript/e2e/mochareports/report-20190403-233429.json"
      ],
      totalDuration: 94597,
      totalFailures: 0,
      totalPasses: 18,
